...
// 이미지 헤더 판독. 값 목록의 정본(vocabulary) 말고는 require를 갖지 않는다 —
// 판정 계층이 이 모듈을 부르므로 그 순수성이 여기까지 이어져야 하고, 정본은
// 스스로 require가 없으므로 그 성질을 깨지 않는다.
//
...
const { ASSET_EXTENSIONS } = require('./vocabulary');
